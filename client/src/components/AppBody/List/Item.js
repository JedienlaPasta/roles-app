...
export default function Item({ COMUNA, ANO, SEMESTRE, ASEO, RUT, PROPIETARIO, DIRECCION, ROL_AVALUO_1, ROL_AVALUO_2, NA, CONTRIBUCION, AVALUO_TOTAL, AVALUO_EXENTO, TER_EXEN, UBICACION, DESTINO }) {
